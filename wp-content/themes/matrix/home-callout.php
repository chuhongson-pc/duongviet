...
$bgvideo = isset($matrix_theme_options['callout_external_bg_video']) && $matrix_theme_options['callout_external_bg_video']!="" ? $matrix_theme_options['callout_external_bg_video'] : ''; ?>
...
<div id="matrix_video" class="section purchase"
    ...
    <div class="container">
     ...
     data-property="{videoURL:'<?php echo esc_url($bgvideo);?>',containment:'#matrix_video',startAt:0,mute:true,autoPlay:true,loop:true,opacity:1,addRaster:true,showControls:false}">
	</div>
